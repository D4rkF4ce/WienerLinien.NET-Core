...
using HiGHTECHNiX.WienerLinienAPI.Model;
using HiGHTECHNiX.WienerLinienAPI.RealtimeData.Monitor;
using HiGHTECHNiX.WienerLinienAPI.RealtimeData.TrafficInfo;
